...
[private reporting form](https://github.com/NiyiOke/open-shed-card-engine/security/advisories/new).
Begin the title with `CODE OF CONDUCT` so it is handled as a conduct report; the
form is also used for security reports. Do not put incident details or personal
